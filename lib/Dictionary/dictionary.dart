...
class _SearchScreenState extends State<Dictionary> {
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.only(
              bottomLeft: Radius.circular(15), // Độ bo tròn của góc dưới bên trái
              bottomRight: Radius.circular(15), // Độ bo tròn của góc dưới bên phải
            ),
          ),
          child: Column(
              children: <Widget>[
                Container(
                  margin: EdgeInsets.only(top: 25.0, right: 10.0, left: 10.0, bottom: 10.0),
                  decoration: BoxDecoration(
                  ...
                  child: TextField(
                    ...
                    style: TextStyle(
                      fontSize: 18.0, // Đặt kích thước văn bản cho text trong TextField
                    ),
                  ),
                ),
                ...
                Container (
                    ...
                    child: ListView(
                      ...
                      children: List.generate(26, (index) {
                        ...
                        return Padding(
                          padding: EdgeInsets.symmetric(horizontal: 3.0), // Thêm khoảng cách giữa các button
                          child: SizedBox(
                            height: 30,
            ...
            children: List.generate(26, (index) {
              return Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(color: Colors.blueAccent, width: 2.0), // Đường viền xung quanh ExpansionTile
